    ...
    const fetchLecture = async () => {
      try {
        ...
        const response = await axios.get(
          `http://localhost:5000/api/lectures/${lectureId}`, // Fetch the specific lecture by ID
          { headers }
        );
      ...
      <div className="mb-5 mt-20 flex justify-center">
        ...
        <div className="w-full max-w-3xl rounded-lg bg-white shadow-md">
          <video controls className="h-96 w-full">
            <source
              src={`http://localhost:5000${lecture.videoUrl}`} // Use the video URL from the lecture data
              type="video/mp4"
            />
        ...
        <div className="mt-4 rounded-lg border border-gray-300 bg-white p-6 shadow-sm">
          <div className="space-y-4">
            ...
            <div>
              ...
              <span className="text-gray-700">{lecture.subject || "N/A"}</span>
            </div>
            <div>
